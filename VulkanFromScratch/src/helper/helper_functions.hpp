...
static void copyBuffer(CoreInstance& core_instance, VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(core_instance.get_device(), core_instance.cmd_pool());

    VkBufferCopy copyRegion{};
    copyRegion.size = size;
    vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, 1, &copyRegion);

    endSingleTimeCommands(core_instance, commandBuffer);
}
...
static void transitionImageLayout(CoreInstance& core_instance, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands(core_instance.get_device(), core_instance.cmd_pool());
